...
const GaragesOverview: React.FC = () => {
  ...
  const loadGarages = async () => {
    try {
      ...
      toast({
        title: 'Erreur',
        description: 'Impossible de charger les garages',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  const handleToggleStatus = async (partnerId: number, isActive: boolean) => {
    try {
      ...
      toast({
        title: 'Succès',
        description: `Garage ${!isActive ? 'activé' : 'désactivé'} avec succès`,
      });
      loadGarages();
    } catch (error) {
      toast({
  ...
  const handleToggleVerification = async (partnerId: number, isVerified: boolean) => {
    try {
      ...
      toast({
        title: 'Succès',
        description: `Garage ${!isVerified ? 'vérifié' : 'non vérifié'} avec succès`,
      });
      loadGarages();
    } catch (error) {
      toast({
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Gestion des garages et centres auto partenaires</p>
        </div>
          ...
          <div className="flex gap-4 flex-wrap">
            <div className="flex-1 min-w-[300px]">
              <div className="relative">
                ...
                <Input
                  placeholder="Rechercher un garage (nom, ville, services)..."
                  className="pl-10"
                  value={searchTerm}
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="verified">Vérifiés seulement</SelectItem>
              </SelectContent>
            </Select>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Garages Partenaires ({partners.length})</CardTitle>
          <CardDescription>
            Gérez tous vos garages partenaires depuis cette interface
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <div className="text-gray-500 mb-4">
                {searchTerm || statusFilter !== 'all' 
                  ...
                  : 'Commencez par ajouter votre premier garage partenaire'
                }
              </div>
              <Button>
...
export default GaragesOverview;