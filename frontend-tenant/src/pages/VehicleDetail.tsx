  ...
  return (
    <div className="space-y-6 p-4">
        ...
        <TabsContent value="overview">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-y-4 text-sm">
              ...
              <span>{vehicle.puissance ? `${vehicle.puissance} ch` : "-"}</span>
              ...
              <span>{vehicle.purchase_price ? `${vehicle.purchase_price.toLocaleString("fr-FR")} €` : "-"}</span>
              <span className="text-slate-500">Prochain CT</span>
              <span>{formatDate(vehicle.next_ct_date)}</span>
              <span className="text-slate-500">Dernier CT</span>
              <span>{formatDate(vehicle.last_ct_date)}</span>
            </CardContent>
          </Card>
        </TabsContent>
      ...
      <CtModal
        ...
        currentLastCT={vehicle.last_ct_date}
        currentNextCT={vehicle.next_ct_date}
        onUpdated={() =>
