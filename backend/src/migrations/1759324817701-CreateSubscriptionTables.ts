...
export class CreateSubscriptionTables1759324817701 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0c5fe8e5f9f4dd4a8c0134abc9" ON "subscriptions" ("tenantId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0c5fe8e5f9f4dd4a8c0134abc9"`);
