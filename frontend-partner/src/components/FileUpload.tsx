 ...
 * This component is duplicated from frontend-client/src/components/documents/FileUpload.tsx
 * Future refactoring: Create frontend-shared package to avoid duplication
 */
